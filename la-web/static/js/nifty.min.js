...
$(document).ready(function() {
	...
	i.on("change", function() {
		i.niftyCheck("isChecked") ? (nifty.container.addClass("effect"), a.prop("disabled", !1).selectpicker("refresh"), u("settings-animation", "effect")) : (nifty.container.removeClass("effect " + n), a.prop("disabled", !0).selectpicker("refresh"), 
		u("settings-animation", "none"))
	}), 
...
var g = $("#demo-navbar-fixed");
	g.on("change", function() {
		g.niftyCheck("isChecked") ? (nifty.container.addClass("navbar-fixed demo-set-no"), u("settings-navbar-fixed", !0)) : (nifty.container.removeClass("navbar-fixed demo-set-no"), u("settings-navbar-fixed", !1)), nifty.mainNav.niftyAffix("update"), nifty.aside.niftyAffix("update")
	});
	...
	var m = $(".demo-theme"),
		h = function(e, t) {
			var n = $("#theme"),
				i = "static/css/themes/themes-" + t + "/" + e + ".min.css";
	...
	$("#demo-page-alert").on("click", function(e) {
		...
		var t = nifty.randomInt(0, 8),
			n = function() {
				return nifty.randomInt(0, 3) < 2 ? 3500 : 0
			}();
		$.niftyNoty({
			type: k[t].type,
			icon: k[t].icon,
			title: function() {
				return n > 0 ? k[t].title + " : Auto close" : k[t].title + " : Sticky Alert"
			}(),
	 ...
	 "undefined" == typeof window.demoLayout) {
		...
		$("#demo-reset-settings").on("click", function() {
			i.niftyCheck("toggleOn"), 
			nifty.container.removeClass(n).addClass("effect"), 
			a.selectpicker("val", "effect"), 
			o.niftyCheck("toggleOff"), 
			$.niftyNav("staticPosition"), 
			s.niftyCheck("toggleOff"), 
			$.niftyNav("expand"), 
			nifty.container.removeClass("mainnav-in mainnav-out mainnav-sm"), 
			f.selectpicker("val", "none"), 
			c.niftyCheck("toggleOff"), 
			$.niftyAside("hide"), 
			d.niftyCheck("toggleOff"), 
			$.niftyAside("staticPosition"), 
			l.niftyCheck("toggleOff"), 
			$.niftyAside("alignRight"), 
			r.niftyCheck("toggleOff"), 
			$.niftyAside("darkTheme"), 
			g.niftyCheck("toggleOff"), 
			nifty.container.removeClass("navbar-fixed"), 
			nifty.mainNav.niftyAffix("update"), 
			nifty.aside.niftyAffix("update"), 
			y.niftyCheck("toggleOff"), 
		...
		$.cookie("settings-animation") && ("none" == $.cookie("settings-animation") ? (nifty.container.removeClass("effect " + n), 
		i.niftyCheck("toggleOff"), 
		a.prop("disabled", !0).selectpicker("refresh")) : (i.niftyCheck("toggleOn"), 
		nifty.container.addClass("effect " + $.cookie("settings-animation")), 
		a.selectpicker("val", $.cookie("settings-animation")))), 
		
		1 == $.cookie("settings-nav-fixed") || nifty.container.hasClass("mainnav-fixed") ? (o.niftyCheck("toggleOn"), 
		$.niftyNav("fixedPosition")) : (o.niftyCheck("toggleOff"), 
		$.niftyNav("staticPosition")), 
		
		1 == $.cookie("settings-nav-collapsed") ? (s.niftyCheck("toggleOn"), 
		$.niftyNav("collapse"), 
		$(".mainnav-toggle").removeClass("push slide reveal")) : (s.niftyCheck("toggleOff"), 
		$.cookie("settings-nav-offcanvas") && (nifty.container.removeClass("mainnav-in mainnav-sm mainnav-lg"), 
		...
		c.niftyCheck(nifty.container.hasClass("aside-in") ? "toggleOn" : "toggleOff"), 
		d.niftyCheck(nifty.container.hasClass("aside-fixed") ? "toggleOn" : "toggleOff"), 
		l.niftyCheck(nifty.container.hasClass("aside-left") ? "toggleOn" : "toggleOff"), 
		r.niftyCheck(nifty.container.hasClass("aside-left") ? "toggleOn" : "toggleOff"), 
		
		1 == $.cookie("settings-navbar-fixed") || nifty.container.hasClass("navbar-fixed") ? (g.niftyCheck("toggleOn"), 
		nifty.container.addClass("navbar-fixed"), 
		nifty.mainNav.niftyAffix("update"), 
		nifty.aside.niftyAffix("update")) : (g.niftyCheck("toggleOff"), 
		nifty.container.removeClass("navbar-fixed"), 
		nifty.mainNav.niftyAffix("update"), 
		nifty.aside.niftyAffix("update")), 
		
		1 == $.cookie("settings-footer-fixed") || nifty.container.hasClass("footer-fixed") ? (y.niftyCheck("toggleOn"), 
		nifty.container.addClass("footer-fixed")) : (y.niftyCheck("toggleOff"), 
		nifty.container.removeClass("footer-fixed")), 
		$.cookie("settings-theme-name") && $.cookie("settings-theme-type") ? (h($.cookie("settings-theme-name"), 
		$.cookie("settings-theme-type")), 
		$(".demo-theme").filter("[data-type=" + $.cookie("settings-theme-type") + "]").filter("[data-theme=" + $.cookie("settings-theme-name") + "]").addClass("disabled")) : $(".demo-theme.demo-c-navy").addClass("disabled")
	}
});

$(document).ready(function(){   
	$('#topmain').bind('click',function(event){
		$("#cdtop").toggleClass("caidantop"); 
      })
}); 